...
[![Docker Cloud Automated build](https://img.shields.io/docker/cloud/automated/samdoran/fedora30-ansible.svg)](https://hub.docker.com/r/samdoran/fedora30-ansible/) ![Docker Pulls](https://img.shields.io/docker/pulls/samdoran/fedora30-ansible.svg)
...
To build your own version of this container, run:
    ...
    docker build -t fedora30-ansible .
...
platforms:
  - name: role-test
    image: "samdoran/${MOLECULE_DISTRIBUTION:-fedora30}-ansible:latest"
