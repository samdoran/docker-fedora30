...
[![Container Repository on Quay](https://quay.io/repository/samdoran/fedora30-ansible/status "Container Repository on Quay")](https://quay.io/repository/samdoran/fedora30-ansible)
...
To build your own version of this container, run:
    ...
    podman build -t fedora30-ansible -f Containerfile .
